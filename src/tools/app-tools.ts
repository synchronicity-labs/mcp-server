  ...
  return [
    ...
    },
    {
      ...
      description:
        ...
        'For files the user already uploaded in chat, pass direct `audio`/`video`/`image` file params to this tool whenever available; use upload-media first only when you need to stage a reusable assetId or the host cannot pass direct file params. If the user wants to choose a local image/audio file that is not attached yet, use open-upload-widget first. ' +
